...
@section('main-content')
    ...
    <!-- Page Heading -->
    <h5 class=" mb-4 text-gray-800">{{ __('Admin Dashboard >  Tax Closing Assignment > ') }} {{ __($data->assignment_title) }}</h5>
    <hr/>    
...
<!-- New assign to contractor function sntart-->
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('admins.assignment.assign', [request()->segment(3), request()->segment(4)]) }}" name="assign_staff" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <div class="col-md-4">
          ...
          <div class="card">
            ...
            <form action="{{ route('admins.assignment.message.fileupload', [request()->segment(3), request()->segment(4), request()->segment(5)]) }}" name="assign_staff" method="post" enctype="multipart/form-data">
          ...
          <hr/>
              ...
              <div class="card">
                ...
                <form action="{{route('admins.assignment.message.sent', [request()->segment(3), request()->segment(4), request()->segment(3)])}}" method="post">

                  <div class="card-footer">
                      @csrf
                        <textarea class="form-control" rows="3" name="message"  required></textarea><br/>
                        <input type="submit" name="submit" value="Send" class="btn btn-sm btn-block btn-success">
                  </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form name="scheduleFix" action="{{route('admin.assignment.complete', [request()->segment(3),request()->segment(4), request()->segment(5)])}}" method="post">
                @csrf
