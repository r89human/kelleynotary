            ...
            @foreach($datas as $data)
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{route('admins.assignment.process_server.view.hash', [$data->hash, strtolower($abc->getStatusByNumber($data->status))])}}" class="btn btn-link">View</a> | 

                  <a href="#" class="btn btn-link" style="color: {{$btn_color}};" data-toggle="modal" data-target="#invoice_{{$data->hash}}">Invoice</a> | 



                  <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('admins.assignment.processserver.view.all', request()->segment(4))}}?do=delete&for={{$data->hash}}" style="color: red;">Delete</a>
                </td>
              </tr>
            ...
            <div class="modal fade" id="invoice_{{$data->hash}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form method="post" action="{{route('admins.assignment.processserver.view.all',[request()->segment(4),'assignment' => $data->hash])}}">
                    @csrf
