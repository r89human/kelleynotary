...
@section('title', 'View all assignments by type')
@section('main-content')

    <!-- Page Heading -->
    <h5 class=" mb-4 text-gray-800">{{ __(ucfirst(request()->segment(1)).' Dashboard >  All '.ucfirst(request()->segment(4))) }} Assignments</h5>
    <hr/>
    ...
    <div class="row">
        ...
        <!-- General Assignments by status -->
        <div class="col-xl-12 col-md-12 mb-4">
          <div class="card">
            <div class="card-body">  
              <div class="card-title text-success">
                <h4>General {{ ucfirst(request()->segment(4)) }}  Assignments</h4>
              </div>
              <hr/>
        ...
        <!-- Real State Close Assignments by status -->
        <div class="col-xl-12 col-md-12 mb-4">
          ...
          <div class="card">
            <div class="card-body">  
              <div class="card-title text-primary">
                <h4>Real State Close  {{ ucfirst(request()->segment(4)) }}  Assignments</h4>
              </div>
              <hr/>
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($real_state_closing as $data)
        ...
        <!-- Tax closing Assignments by status -->
        <div class="col-xl-12 col-md-12 mb-4">
            
          <div class="card">
            <div class="card-body">  
              <div class="card-title text-info">
                <h4> Tax Closing  {{ ucfirst(request()->segment(4)) }}  Assignments</h4>
              </div>
              <hr/>
                <table class="table table-bordered">
                  <tr class="thead-light">
                  ...
                  @foreach($tax_closing_assignment as $data)
        ...
        <!-- Process server Assignments by status -->
        <div class="col-xl-12 col-md-12 mb-4">
            
          <div class="card">
            <div class="card-body">  
              <div class="card-title text-secondary">
                <h4>Process Server  {{ ucfirst(request()->segment(4)) }}  Assignments</h4>
              </div>
              <hr/>
              ...
              <table class="table table-bordered">
                ...
                @foreach($process_server_assignment as $data)
