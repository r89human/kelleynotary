...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Create new member') }}</h1>
        ...
        <div class="col-lg-8 offset-md-2">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">New user account</h6>
                </div>
                ...
                @if(request()->segment(1)=='staff')
                    <form method="POST" action="{{ route('staffs.new.memeber.create') }}" autocomplete="off">
                @elseif(request()->segment(1)=='admin')
                    <form method="POST" action="{{ route('admins.new.memeber.create') }}" autocomplete="off">
                @endif
