              ...
              <tr>
                ...
                <td>
                  ...
                  ?>
                    ...
                    ?>
                <td>
                  <a href="{{route('staffs.assignment.real_state_closing.view.hash', [$data->hash, strtolower($abc->getStatusByNumber($data->status))])}}" class="btn btn-link">View</a> | 
            ...
            <div class="modal fade" id="invoice_{{$data->hash}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form method="post" action="{{route('staffs.assignment.realstate.view.all',[request()->segment(4),'assignment' => $data->hash])}}">
                    @csrf
